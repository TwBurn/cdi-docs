...
- [`pt_coord()`](#pt_coord-return-pointer-coordinates) Return pointer coordinates
...
### `gc_blnk()` Set the Graphics Cursor Blink Rate
*UCM File Manager C Binding*
...
### `gc_col()` Set the Graphics Cursor Color
*UCM File Manager C Binding*
...
### `gc_hide()` Hide the Graphics Cursor
*UCM File Manager C Binding*
...
### `gc_org()` Set the Graphics Cursor Origin
*UCM File Manager C Binding*
...
### `gc_ptn()` Set the Graphics Cursor Pattern
*UCM File Manager C Binding*
...
### `gc_show()` Show the Graphics Cursor
*UCM File Manager C Binding*
...
### `pt_coord()` Obtain Pointer Coordinates
*UCM File Manager C Binding*
...
### `sm_cncl()` Conceal Error in a Soundmap
*CDFM File Manager C Binding*
...
### `ss_enable()` Enable Hardware Control Buttons of Player
*CDFM File Manager C Binding*
...
### `ss_opt()` Set Options of Path Descriptor
*CDFM File Manager C Binding*
...
### `viq_txtl()` Calculate Pixel Length of Text
*UCM File Manager C Binding*
